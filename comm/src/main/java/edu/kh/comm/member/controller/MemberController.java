...
public class MemberController {
	...
	// private MemberService service = new MemberServiceImpl(); // IOC(제어의 역전) : new 연산자를 통해 개발자가 직접 객체 생성하지 않는다.
	...
	*/
	...
	public String login( @RequestParam("inputEmail") String inputEmail, 
		...
		// email 숫자만 입력받는다고 가정
		// logger.debug(inputEmail + 100); // inputEmail의 타입을 int로 설정
